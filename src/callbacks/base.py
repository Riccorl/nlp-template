    ...
    def _get_datasets_and_dataloaders(
        ...
        Args:
            ...
            dataloader_kwargs (`Optional[Dict[str, Any]]`):
                The kwargs to use when instantiating the dataloader.
            collate_fn (`Optional[Callable]`):
                The collate function to use when instantiating the dataloader.
            collate_fn_kwargs (`Optional[Dict[str, Any]]`):
                The kwargs to use when instantiating the collate function.
